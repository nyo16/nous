defmodule YggdrasilWeb.AgentChatLive do
  @moduledoc """
  Single-page LiveView chat interface with Yggdrasil agent.
  ...
  1. Add to your Phoenix router:
      ...
      live "/chat", YggdrasilWeb.AgentChatLive
    ...
    <div class="flex flex-col h-screen bg-gray-50">
      ...
      <div class="bg-white border-t border-gray-200 px-6 py-4">
        ...
        <div class="mt-2 text-xs text-gray-500 text-center">
          Session: <%= @session_id %> •
          Powered by <span class="font-semibold">Yggdrasil AI</span>
        </div>
      </div>
    </div>
    """
