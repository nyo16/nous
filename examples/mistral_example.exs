...
agent = Nous.new("mistral:ministral-3-14b-instruct-2512",
...
{:ok, result} = Nous.run(agent, "Hello! Tell me about Mistral AI in 2-3 sentences.")
...
{:ok, stream} = Nous.run_stream(agent, "Count from 1 to 5, explaining why each number is interesting.")
...
focused_agent = Nous.new("mistral:ministral-3-14b-instruct-2512",
...
{:ok, result2} = Nous.run(focused_agent, "What is 2+2? Be precise.")
