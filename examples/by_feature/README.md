...
Find examples showcasing specific Nous capabilities. Jump directly to the features you need.
...
{:ok, stream} = Nous.run_stream(agent, "Search for weather in Paris",
...
react_agent = Nous.ReActAgent.new("lmstudio:qwen/qwen3-30b",
