...
# Nous AI - Streaming Responses Example
...
case Nous.run_stream(agent, "Explain how machine learning works in simple terms, including examples.") do
  {:ok, stream} ->
    stream
...
case Nous.run_stream(agent, "Describe the benefits of AI agents with real-world examples and use cases.") do
  {:ok, stream} ->
...
case Nous.run_stream(agent, "What do you think the future of AI technology looks like? Include potential impacts on society.") do
  {:ok, stream} ->
