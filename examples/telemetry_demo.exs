...
IO.puts("  • exadantic.agent.run.start - When agent starts")
IO.puts("  • exadantic.model.request.start - Before API call")
IO.puts("  • exadantic.model.request.stop - After API responds")
IO.puts("  • exadantic.tool.execute.start - Before tool runs")
IO.puts("  • exadantic.tool.execute.stop - After tool completes")
IO.puts("  • exadantic.agent.run.stop - When agent finishes")
IO.puts("")
