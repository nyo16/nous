...
{:ok, result1} = Nous.run(agent, "What is the latest version of Elixir programming language? Use web search to find current info.")
...
{:ok, result2} = Nous.run(agent, "What are the latest AI developments? Search the news.")
