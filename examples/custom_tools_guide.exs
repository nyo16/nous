...
# Yggdrasil AI - Custom Tools Development Guide
...
basic_agent = Yggdrasil.new("lmstudio:qwen/qwen3-30b",
  instructions: """
...
Enum.each(basic_examples, fn example ->
  ...
  case Yggdrasil.run(basic_agent, example) do
    {:ok, result} ->
...
advanced_agent = Yggdrasil.new("lmstudio:qwen/qwen3-30b",
  instructions: """
...
Enum.each(advanced_examples, fn example ->
  ...
  case Yggdrasil.run(advanced_agent, example, deps: %{database: "mock_database_connection"}) do
    {:ok, result} ->
      IO.puts("🤖 Response: #{result.output}")
...
best_practice_agent = Yggdrasil.new("lmstudio:qwen/qwen3-30b",
  instructions: """
...
Enum.each(best_practice_examples, fn example ->
  ...
  case Yggdrasil.run(best_practice_agent, example, deps: weather_context) do
    {:ok, result} ->
      IO.puts("🤖 Response: #{result.output}")
...
composite_agent = Yggdrasil.new("lmstudio:qwen/qwen3-30b",
  instructions: """
...
Enum.each(composite_examples, fn example ->
  ...
  case Yggdrasil.run(composite_agent, example) do
    {:ok, result} ->
