# 🚀 Getting Started with Nous AI (5 minutes)

Get from zero to AI agent in 5 minutes! This guide gets you running your first Nous example as fast as possible.
...
```bash
# In your Nous project directory
...
- **Run from project root:** Make sure you're in the Nous project directory
