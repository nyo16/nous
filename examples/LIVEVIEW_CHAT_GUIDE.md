# LiveView Chat with Nous AI

Complete guide for building a real-time chat interface with Nous agents using Phoenix LiveView and PubSub.
...
1. **`lib/nous/agent_server.ex`** - GenServer wrapper for agents with PubSub integration
...
cp lib/nous/agent_server.ex lib/my_app/agent_server.ex
```
...
- GitHub Issues: https://github.com/yourusername/nous/issues
