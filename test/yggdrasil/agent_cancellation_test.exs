defmodule Yggdrasil.AgentCancellationTest do
  use ExUnit.Case, async: true

  alias Yggdrasil.{Agent, Tool, Errors}
  ...
  describe "AgentServer cancellation" do
    test "tracks current task" do
      ...
      Yggdrasil.AgentServer.send_message(pid, "Test")
      Process.sleep(10)
      ...
      {:ok, :cancelled} = Yggdrasil.AgentServer.cancel_execution(pid)
      Process.sleep(10)
    ...
    test "returns :no_execution when nothing is running" do
      ...
      {:ok, :no_execution} = Yggdrasil.AgentServer.cancel_execution(pid)
    end
    ...
    test "cancels existing task when new message arrives" do
      ...
      Yggdrasil.AgentServer.send_message(pid, "First message")
      Process.sleep(10)
      ...
      Yggdrasil.AgentServer.send_message(pid, "Second message")
      Process.sleep(10)
