defmodule Nous.Models.Gemini do
  ...
  **Note:** This provider requires the optional `gemini_ex` dependency.
  Add it to your deps: `{:gemini_ex, "~> 0.8.1"}`
  """
  ...
  def request(model, messages, settings) do
    unless @gemini_available do
      raise Errors.ConfigurationError,
        message: "gemini_ex dependency not available. Add {:gemini_ex, \"~> 0.8.1\"} to your deps."
    end
