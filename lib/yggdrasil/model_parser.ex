defmodule Yggdrasil.ModelParser do
  ...
  ## Examples
      ...
      iex> ModelParser.parse("custom:my-model", base_url: "http://localhost:8080/v1")
      %Model{provider: :custom, model: "my-model", base_url: "http://localhost:8080/v1"}
