defmodule Yggdrasil.Models.Anthropic do
  @moduledoc """
  ...
  Note: While Anthropic also offers an OpenAI-compatible API, this adapter uses
  the native Anthropic API for full feature access.
  """
