defmodule Yggdrasil.Models.Mistral do
  @moduledoc """
  ...
  ## Usage
      ...
      # Basic usage
      model = Yggdrasil.ModelParser.parse("mistral:mistral-large-latest")

      # With custom settings
      model = Yggdrasil.ModelParser.parse("mistral:mistral-small-latest",
        default_settings: %{
          temperature: 0.7,
          max_tokens: 1000,
          reasoning_mode: true
